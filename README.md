# Math32_JupyterNotebooks_Python
...
JupyterNotebooks in python from my stats and probability class of Math 32. Note to run/modify them you would have to go to JupyterNotebooks and open the .ipynb file.
